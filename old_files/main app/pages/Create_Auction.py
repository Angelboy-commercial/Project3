...
beneficiary = st.text_input("Enter the beneficiary's address")
...
if st.button("Register NFT"):
    ...
    tx_hash = contract.functions.createToken(name_, description, beneficiary, int(end_time), uri).transact({'from': address, 'gas': 1000000})
